package com.runny.tea_mod_from_runny;
...
@Mod(TeaModFromRunny.mod_id)
public class TeaModFromRunny {
    public static final String mod_id = "tea_mod_from_runny";
    private static final Logger LOGGER = LogUtils.getLogger();

    public TeaModFromRunny() {
