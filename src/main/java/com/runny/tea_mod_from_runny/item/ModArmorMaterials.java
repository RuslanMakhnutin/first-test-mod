...
public enum ModArmorMaterials implements ArmorMaterial {
    MANGANITE("manganite",26,new int[]{ 5, 10, 8, 5 }, 25, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.5f, 0.1f,
            () -> Ingredient.of(ModItems.MANGANITE.get()));
    ...
    private static final int[] BASE_DURABILITY = {21, 28, 26, 24};
    ...
    public String getName() {
        return TeaModFromRunny.mod_id + ":" + this.name;
    }
